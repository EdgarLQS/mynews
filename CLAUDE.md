...
- 当前唯一实施顺序和验收门槛见[统一开发总计划](docs/planning/v1.7-v2.0-master-plan.md)；v1.7 P0–P4 与更早来源吸收记录已归档，具体规则仍以 `AGENTS.md` 为准。
...
- v1.5 P1–P5 已有离线实现；`--plugin`、`--with-plugin`、`watchlist` 和独立来源包的真实验收仍必须按统一总计划记录，fixture/mock 不能升级为 `Verified`。
