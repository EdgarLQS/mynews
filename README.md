...
> 当前状态：v1.2 受控证据解析、pending 增量核验、原子状态事务和证据生命周期已实现；Python 3.12 下文档、diff、Ruff、Mypy、153 项全量测试和中文 CLI help 本地复验通过。真实来源 G6-S、生产 Codex G6-V 与隔离两次真实七天运行 G7 已整理为独立交接清单，G6-V 尚未满足前不宣称 Verified。v1.1 原计划及未完成门禁记录已完整归档。真实 launchd 按验收边界未加载。
