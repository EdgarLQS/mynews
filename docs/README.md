...
| v1.5 扩展来源与安全交接计划 | Current / Implemented | P1–P5 离线实现和门禁已通过；P6 已记录逐来源真实 probe，11 个来源有有效记录，2 个合法空 Feed，2 个 FAIL；整体仍不能把新增来源批量写成 Verified |
...
7. [架构决策记录](decisions/README.md)：查看关键设计及其理由。
8. [历史归档](archive/README.md)：追溯 v1.2 计划、真实验收和更早历史。
