...
| `docs/planning/v1.2-evidence-lifecycle-plan.md` | `plan/2026/v1.2-evidence-lifecycle-plan.md` | 2026-08-09 | v1.2 被 v1.3 情报简报替代；保留实际离线门禁和真实 G6-S/G6-V/G7 结论 | [v1.3 归档计划](plan/2026/v1.3-intelligence-digest-plan.md) |
...
| `docs/planning/v1.3-intelligence-digest-plan.md` | `plan/2026/v1.3-intelligence-digest-plan.md` | 2026-08-09 | v1.3 已按 Implemented 完成并被 v1.4 外部来源插件计划替代；真实 Digest Codex `BLOCKED` 记录保留 | [v1.4 计划](../planning/v1.4-source-plugins-plan.md) |
